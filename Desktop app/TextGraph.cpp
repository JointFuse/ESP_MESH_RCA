...
struct TextGraph_lib::asynch_send_dat {
...
ostream& TextGraph_lib::operator<< (ostream& os, MacAddr addr)
{
    ostringstream info;
 ...
 *  Keystroke handler 
 */
void TextGraph_lib::keyboard_check(ConnectHub* own)
{
    stringstream info;
 ...
 */
void TextGraph_lib::asynch_send(asynch_send_dat dat)
{
    Network::NetErr res;
 ...
 */
void TextGraph_lib::asynch_keyset(ConnectHub* own)
try{
    stringstream info;
    int pressed{ 0 };
 ...
 */
void TextGraph_lib::asynch_setspeed(ConnectHub* own)
try {
    stringstream info;
    info.str("");
 ...
 */
void TextGraph_lib::asynch_write_message(ConnectHub* own)
try{
    ostringstream info;
